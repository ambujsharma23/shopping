...
<!--if(get_id("online_shopping_frequency8").value!= '8'){-->
    if(chkVar==true){
        var elements = document.querySelectorAll('.mode_of_payment');
        var checked = false;
        for (counter = 0; counter < elements.length; counter++)
        {
          if (elements[counter].checked==true)
        ...
        if(!checked){
          alert('For the products purchased by you in the last 2 weeks, what all mode of payments did you use?');
          chkVar = true;
          return false;
        }
    }
...
<script>
  ...
  $(document).ready(function(){
	...
	///08-11-16  21-a new question added rt //
	 $("#mode_of_payment8").click(function(){
      if($('#mode_of_payment8').is(":checked")){
        $("#mode_of_payment_other").val('');
        $("#mode_of_payment_other_div").show();
      }
      else {
        $("#mode_of_payment_other_div").hide();
        $("#mode_of_payment_other").val('');
      }
    });
	 ...
	 $("#mode_of_payment8").click(function(){
      if($('#mode_of_payment8').is(":checked")){
        $("#mode_of_payment_other1").val('');
        $("#mode_of_payment_other_div1").show();
      }
      else {
        $("#mode_of_payment_other_div1").hide();
        $("#mode_of_payment_other1").val('');
      }
    });
	//end
...
<?php if(isset($_SESSION['product_brought_98']) && $_SESSION['product_brought_98']=='98'){ ?>
    ...
    <!--11nov16 inhouse Q21-a rt-->
    <!--<div class="content2_l1" style="width:995px;">
        <span class="content2_l1_span" style="width:70%">For all the products purchased by you in the last 2 weeks, what mode of payments did you use for each of the purchases? (Select for each of your purchases)</span>
           <div style="float:left;margin-right: 20px;">
            <?php //AddDropDown("mode_of_payment.xml","mode_of_payment","style_dd", "Mode of Payment", "", "", "1");?>
            </div>
        </div>-->
		
		  <div class="content2_l1" style="width:995px;margin-top:5px;">
		  <span class="content2_l1_span" style="width:70%">For the products purchased by you in the last 2 weeks, what all mode of payments did you use?
</span>
          <div style="float:left;margin-right:32px;">  <?php
              AddCheckBox1("mode_of_payment.xml",'N',"mode_of_payment","#7FB3E6","0","0","2","7",'100%','',false,array('this.id','this.value','12','12'),'1','350px');
              ?>
              <span id="mode_of_payment_other_div1" style="display:none; padding-left:2px; margin-top:10px;"><input type="text" value="" name="mode_of_payment_other1" id="mode_of_payment_other1" placeholder="other purchases"></span>
          </div>
        </div>
<!--end 11-nov-16-->
...
<?php if(!isset($_SESSION['product_brought_98'])){ ?>
       ...
       <!--11nov16 inhouse Q21-a rt-->
		...
		<div class="content2_l1" style="width:995px;margin-top:5px;">
		  <span class="content2_l1_span" style="width:70%">For the products purchased by you in the last 2 weeks, what all mode of payments did you use?
</span><div style="float:left;margin-right:32px;">  <?php
              AddCheckBox1("mode_of_payment.xml",'N',"mode_of_payment","#7FB3E6","0","0","2","7",'100%','',false,array('this.id','this.value','12','12'),'1','350px');
              ?>
              <div id="mode_of_payment_other_div" style="display:none; padding-left:13px; margin-top:10px; clear:both;"><input type="text" value="" name="mode_of_payment_other" id="mode_of_payment_other" placeholder="other purchases"></div>
          </div>
        </div>
      <!--end 11-nov-16-->
