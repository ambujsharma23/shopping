...
$(document).ready(function(){
  ...
  $("#not_purchase_reason_for_chroma_both").hide();
  $("#not_purchased_and_not_visited_from_chroma").hide();
  ...
  $("#not_purchased_and_not_visited_from_chroma_mobile").hide();
  ...
  $("#not_purchased_and_not_visited_from_chroma_kitchen").hide();
  ...
  $("#not_purchased_and_not_visited_from_chroma_laptop").hide();
  ...
  $("#not_purchased_and_not_visited_from_chroma_tablet").hide();
...
//personel_care_store_1
    ...
    $("#purchase_personel_care").html('<option value="">Personel care Appliances</option>');        
 ...
 //personel care chroma both not purchase products reason// {
      ...
      //alert($(this).val());     
       if($(this).val()=='2' || $(this).val()=='13'){
          ...
          $("#not_purchase_reason_for_chroma_both").show();
       }          
    });

//end personel care chroma both not purchase products reason// 

 //  FOR personel_care  not VISITED not purchased chroma//
   //personel_care_store_1
    $("select[name^=personel_care_store_]").change(function() {
      $("#not_purchase_reason_for_chroma_both").hide();
      $("#non_visited_croma_personel_care").hide();
      ...
      $("select[name^=personel_care_store_]").each(function() {
        if($(this).val()!= 2 || $(this).val()!= 13) {
          //alert('here');
          if(!checkPurchased('purchase_personel_care')) {
            $("#not_purchase_reason_for_chroma_both").toggle();
    ...
    <!--start visit next 3 stores for tablet section-->
      <div class="content2" id="three_more_tablet" style="display:none;">
        <div class="content2_l1" style="width:995px;">
          ...
          <div style="float:left;" class="tablet_one" style="display:none;">personel_care
            <?php
...
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in tablet div section --> 
...
<!--end purchase reason from new offline/physical stores coded in tablet div section --> 
 ...
 <!--start purchase reason from new online stores coded in tablet div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n tablet div section --> 
    <div class="content2" id="not_purchase_reason_for_chroma_both_tablet">
       <span class="content2_l1_span">You mentioned you have not visited/purchased the product from Croma. Please state the reasons for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
              AddCheckBox1("not_purchased_from_chroma_or_chromaretail.xml",'N',"not_purchased_from_chroma_or_chromaretail","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
              ?></div>
        </div>    
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n tablet div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma_tablet" style="display:none;">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
              //AddCheckBox1("not_purchased_and_not_visited_from_chroma.xml",'N',"not_purchased_and_not_visited_from_chroma","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
              ?></div>
        </div>        
      </div><div style="clear:both;"></div>
<!--end purchase reason from new online stores coded in tablet div section --> 
...
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in laptop div section --> 
    <div class="content2" id="purchase_reason_for_offline_laptop">
       <span class="content2_l1_span">Please state the reasons of purchasing it from <u><span id="laptop_value2"></span></u></span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
              AddCheckBox1("product_from_extra_product_personel_care_appliance.xml",'N',"product_from_extra_product_personel_care_appliance","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
              ?></div>
        </div>    
...
<!--end purchase reason from new offline/physical stores coded in laptop div section --> 
 ...
 <!--start purchase reason from new online stores coded in laptop div section --> 
    <div class="content2" id="purchase_reason_for_online_laptop">
       <span class="content2_l1_span">Please state the reasons of purchasing it from <u><span id="laptop_value3"></span></u></span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
              AddCheckBox1("product_from_extra_product_personel_care_appliance2.xml",'N',"product_from_extra_product_personel_care_appliance2","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
              ?></div>
        </div>    
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n laptop div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n laptop div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma_laptop" style="display:none;">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in kitchen div section --> 
...
<!--end purchase reason from new offline/physical stores coded in personel care kitchen div section --> 
 ...
 <!--start purchase reason from new online stores coded in kitchen div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n kitchen div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n kitchen div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma_kitchen" style="display:none;">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in mobile div section --> 
...
<!--end purchase reason from new offline/physical stores coded in mobile div section --> 
 ...
 <!--start purchase reason from new online stores coded in mobile div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n personel care div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n mobile div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma_mobile" style="display:none;">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in tv div section --> 
...
<!--end purchase reason from new offline/physical stores coded in tv div section --> 
 ...
 <!--start purchase reason from new online stores coded in tv div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n personel tv section --> 
    <div class="content2" id="not_purchase_reason_for_chroma_both_tv">
       <span class="content2_l1_span">You mentioned you have not visited/purchased the product from Croma. Please state the reasons for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
              AddCheckBox1("not_purchased_from_chroma_or_chromaretail.xml",'N',"not_purchased_from_chroma_or_chromaretail_tv","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
              ?></div>
        </div>    
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n personel care div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma_tv" style="display:none;">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--start 23march-->
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in appliances div section --> 
...
<!--end purchase reason from new offline/physical stores coded in personel care div section --> 
 ...
 <!--start purchase reason from new online stores coded in appliance div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n personel care div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma_appliance">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--personel care appliances-->
 <!--start purchase personel care div section -->
      <div class="content2" id="personel_care_div">
        <div class="content2_l1" style="width:995px; float: none;">
          <div style="float: left;padding-right: 10px;">
          <?php AddDropDown("purchase_product.xml","purchase_personel_care","style_dd select_shop", "Personal Care Appliances (Electric shavers, Trimmers, Hair Dryers, etc.)", "", "", "1"); ?>
            </div>
        </div>
        <!-- rt -->
        <div class="content2_l1" style="width:995px; float: none; margin: 0;">
...
<!--21march-->
 <!--start purchase reason from new offline/physical stores coded in personel care div section --> 
...
<!--end purchase reason from new offline/physical stores coded in personel care div section --> 
 ...
 <!--start purchase reason from new online stores coded in personel care div section --> 
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n personel care div section --> 
    <div class="content2" id="not_purchase_reason_for_chroma_both">
       <span class="content2_l1_span">You mentioned you have not visited/purchased the product from Croma. Please state the reasons for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--start purchase reason from ASK Q17 if CROMA or Cromaretail.com is NOT mentioned in Q15 AND CROMA is NOT mentioned Q14 n personel care div section --> 
    <div class="content2" id="not_purchased_and_not_visited_from_chroma" style="display:none;">
       <span class="content2_l1_span">It seems you have visited Croma store but have not purchased from Croma. Pleases state the reason for not purchasing from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
...
<!--       <div class="content2_l1"  id="non_visited_croma_personel_care">
      <span class="content2_l1_span">You mentioned you have not purchased the Personel Care from Croma.Please state the reasons for not purchasing it from Croma?</span>
        ...
        <div style="clear:both;"></div>
        <!--rtt-->
<!--         <div id="visited_croma_personel_care" class="visted_chroma">
        <span>It seems you have visited Croma store but have not purchased  from Croma. Pleases state the reason for the same </span>
        <label><input type="text" class="reason_for_not_purchasing_from_chroma" name="reason_for_not_purchasing_from_chroma_personel_care" id="reason_for_not_purchasing_from_chroma_personel_care" value="" placeholder=""></label>
        </div> -->
        <!--rtc-->
