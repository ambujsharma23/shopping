...
<script type="text/javascript">
  function addPurchaseVisitedPanel(product, store) {
    var htmlData = '<div class="content2" id="purchase_reason_tablet_both">';
      htmlData += '<div class="content2_l1" style="width:995px;">';
      htmlData += '<span class="content2_l1_span">How likely is that you will recommend the stores which you visited from <u>'+store+'</u> to a friend or colleague??</span>';
      ...
      htmlData += '      <td style="width:12%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new1_'+store+'" value="1"></td>';
      htmlData += '      <td style="width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new2_'+store+'" value="1"></td>';
      htmlData += '      <td style="width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new3_'+store+'" value="3"></td>';
      htmlData += '      <td style="width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new4_'+store+'" value="4"></td>';
      htmlData += '      <td style=" width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new5_'+store+'" value="5"></td>';
      htmlData += '      <td style=" width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new6_'+store+'" value="6"></td>';
      htmlData += '      <td style=" width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new7_'+store+'" value="7"></td>';
      htmlData += '      <td style=" width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new8_'+store+'" value="8"></td>';
      htmlData += '      <td style=" width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both" id="'+product+'_likely_to_recommend_new9_'+store+'" value="9"></td>';
      htmlData += '      <td style=" width:10%;border:0px solid #cccccc;"><input type="radio" name="'+product+'_likely_to_recommend_both_'+product+'" id="'+product+'_likely_to_recommend_new10_'+store+'" value="10"></td>';
      htmlData += '    </tr>';
      htmlData += '  </table>';
      htmlData += '</div>';
      htmlData += '<div style="clear:both;"></div>';
      ...
      htmlData += '    <div style="float:left;margin-right: 20px;"><input type="text" name="'+product+'_recommending_'+store+'" id="'+product+'_recommending_'+store+'" value="" />';
      htmlData += '  </div>';
      htmlData += '</div>';
      htmlData += '</div>';
    ...
    $("#purchase_tablet").change(function(){
        ...
        $("#"+selectedId).find("option").each(function() {
          if(($(this).val() != '') && ($(this).val() != selectedVal)) {
            ...
            var store = $(this).text();
            addPurchaseVisitedPanel(product, store);
          }
        });
        // End 10th May //
    });
