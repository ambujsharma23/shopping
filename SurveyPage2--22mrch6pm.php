...
///21march16
  //  FOR personel_care  not VISITED not purchased//
   /* //personel_care_store_1
    $("select[name^=personel_care_store_]").change(function() {
      $("#visited_croma_personel_care").hide();
      $("#non_visited_croma_personel_care").hide();
...
//check not//
//21march16
  /*  function checkVisited1(visitedName1) {
      var visited1 = false;
      $("select[name^="+visitedName1+"_]").each(function() {
        if($(this).val() == 2 || $(this).val() == 12) {
          visited1 = true;
        }
      });
    ...
    function checkPurchased1(purchaseId1) {
      var purchased1 = false;
      if($("#"+purchaseId1+" option:selected").val() == 2 || $("#"+purchaseId1+" option:selected").val() == 12) {
        purchased1 = true;
      }
...
//
      $("#purchase_personel_care").change(function(){
        if($(this).val()!='2' || $(this).val()!='13'){
          //$("#purchase_reason_personel_care").show();
          $("#not_purchased_and_not_visited_from_chroma").show();
...
//end personel care online products reason// 
 ...
 //$("select[name^=personel_care_store_]").change(function() || $("#purchase_personel_care").change(function() {
      $("#purchase_personel_care").change(function(){        
       if($(this).val()!='2' || $(this).val()!='13'){
...
not_purchased_and_not_visited_from_chroma
...
<!--end 21march-->
 ...
 <!--start purchase reason from chroma personel care div section --> 
    <div class="content2" id="purchase_reason_personel_care">
       <span class="content2_l1_span">You mentioned you have purchased the Personel Care Appliances from Croma. Please state the reasons of purchasing it from Croma?</span>
        <div class="content2_l1">
          <div style="float: left;margin-right: 20px;">
             <?php
              AddCheckBox1("product_from_croma_personel_care_appliance.xml",'N',"product_from_croma_personel_care_appliance","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
              ?></div>
        </div>
      <div class="content2_l1" style="width:995px;">
