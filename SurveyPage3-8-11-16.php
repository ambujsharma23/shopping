...
<?php if(isset($_SESSION['product_brought_98']) && $_SESSION['product_brought_98']=='98'){ ?>
    ...
    <!--11nov16 inhouse rt-->
    <div class="content2_l1" style="width:995px;">
        <span class="content2_l1_span" style="width:70%">For the products purchased by you in the last 2 weeks, what mode of payment did you use for the purchase?</span>
