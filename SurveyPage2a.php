    ...
    <FORM name="form2" id="form2" class="styleThese" method="POST" action="ServerPage2.php">
     ...
     <!---- RTTT---- >
      ...
      <div class="content2" id="tablet_div">
        <div class="content2_l1" style="width:995px;">
          <div style="float: left;padding-right: 10px;" id="">
              <?php AddDropDown("tablet.xml","purchase_tablet","style_dd select_shop", "Tablet", "", "", "1"); ?>
            </div>
        </div>
      </div>

       <div class="content2_l1" style="width: 995px;">
           <div style="float:left;margin-right: 20px;"><input type="text" name="tablet_not_recommending" id="tablet_not_recommending" value=""  placeholder="Model Name">
          </div>
      </div>     
