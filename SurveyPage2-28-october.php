      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          <tr>
            ...
            <td colspan="2" style=" width:23%; border:0px solid #cccccc;"><span class="content2_l1_span" style="text-align:right;color:#626262!important;">Extremely Likely</span></td>
          </tr>
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="tablet_likely_to_recommend" id="tablet_likely_to_recommend_1" value="1"></td>
...
<!------>
    ...
    <div class="content2" id="not_purchase_reason_tablet">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="tablet_not_likely_to_recommend" id="tablet_not_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="purchase_reason_laptop">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="laptop_likely_to_recommend" id="laptop_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="not_purchase_reason_laptop">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="laptop_not_likely_to_recommend" id="laptop_not_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="purchase_reason_kitchen">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="kitchen_likely_to_recommend" id="kitchen_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="not_purchase_reason_kitchen">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="kitchen_not_likely_to_recommend" id="kitchen_not_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="purchase_reason_mobile">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="mobile_likely_to_recommend" id="mobile_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="not_purchase_reason_mobile">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="mobile_not_likely_to_recommend" id="mobile_not_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="purchase_reason_tv">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="tv_likely_to_recommend" id="tv_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="not_purchase_reason_tv">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="tv_not_likely_to_recommend" id="tv_not_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="purchase_reason_appliance">
      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="appliance_likely_to_recommend" id="appliance_likely_to_recommend_1" value="1"></td>
    ...
    <div class="content2" id="not_purchase_reason_appliance">
      ...
      <div class="content2_l1" style="width:995px;">
        <span class="content2_l1_span">How likely is that you will recommend Large Appliances (Refrigerator,AC,Washing Machine ) you made a purchase from to a friend or colleage ?</span>
        <div style="clear:both;"></div>
        <table width="100%">
          <tr>
            <td colspan="3" style="border:0px solid #cccccc;"><span class="content2_l1_span" style="width:100%;text-align:left;color:#626262!important;">Not Likely at all recommend</span></td>
          ...
          <tr>
            <td style="width:16%;border:0px solid #cccccc;"><input type="radio" name="appliance_not_likely_to_recommend" id="appliance_not_likely_to_recommend_1" value="1"></td>
