...
<?php if($_SESSION['buy_product_3']==3){?>
  ...
  if($('#future_mobile option:selected').val()=="2" || $('#future_mobile option:selected').val()=="12"){
...
<?php if($_SESSION['buy_product_5']==5){?>
  ...
  if($('#future_kitchen option:selected').val()=="2" || $('#future_kitchen option:selected').val()=="12"){
...
<?php }?>
<?php if($_SESSION['buy_product_6']==6){?>
  if($('#future_appliance option:selected').val()=="0"){
    ...
    if($('#future_appliance option:selected').val()=="2" || $('#future_appliance option:selected').val()=="12"){
...
/*  $("#future_not_purchase_reason").hide();
  $("#future_purchase_reason").hide();  
      $(".future_store").change(function(){
      $(this).each(function(){
          if($(this).val()=='2' || $(this).val()=='12'){
            $("#future_purchase_reason").show();
            $("#future_not_purchase_reason").hide();
          }else if($(this).val()!='2' || $(this).val()!='12'){
            $("#future_not_purchase_reason").show();
            $("#future_purchase_reason").hide();
          }
      });
...
<div class="wealthbutton"></div>
  <div class="parent_main">
    ...
    <?php //if($_SESSION['buy_product_1']==1 || $_SESSION['buy_product_2']==2 || $_SESSION['buy_product_5']==5) {?>
     <?php if(isset($_SESSION['buy_product_1']) && $_SESSION['buy_product_1']!='') { ?> 
      <div class="content2" id="future_tablet_div">
        <div class="content2_l1" style="width:995px;">      
          
          <div style="float: left;padding-right: 10px;">
            <?php AddDropDown("buy_earlier_mentioned_products.xml","future_tablet","style_dd future_store", "Tablets", "", "", "1"); ?>
          </div>
        </div>
      </div>
    ...
    <div class="content2" id="future_laptop_div">
      ...
      <div class="content2" id="future_kitchen_div">
        <div class="content2_l1" style="width:995px;">  
          <div>
              <?php AddDropDown("buy_earlier_mentioned_products.xml","future_kitchen","style_dd future_store", "Kitchen Appliances (Microwave,Mixer,Juicer, etc)", "", "", "1"); ?>
            </div>
