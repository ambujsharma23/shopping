 ...
 */
	...
	////04-01-16//
		$(document).ready(function(){})
			$('#purchase_tablet').click(function(){
			 var optVal = '';
			 for(var i=1; i<=6; i++){
			  var dta = $('#tablet_store_'+i).val();
			  var dtav = $( "#tablet_store_"+i+" option:selected" ).text();			
			$(this).html('<option value="">Tablet</option>');			   
			  if(dta!= 0){  
			...
			$('#purchase_mobile').click(function(){
			 var optVal = '';
			 for(var i=1; i<=6; i++){
			  var dta = $('#mobile_store_'+i).val();
			  var dtav = $( "#mobile_store_"+i+" option:selected" ).text();
				$(this).html('<option value="">Mobile</option>');
			  if(dta!= 0){  
			   var tdat = '<option value="'+dta+'">'+dtav+'</option>';  
			   optVal = optVal+tdat;
			  }
			...
			$('#purchase_appliances').click(function(){
			 var optVal = '';
			 for(var i=1; i<=6; i++){
			  var dta = $('#large_appliance_store_'+i).val();
			  var dtav = $("#large_appliance_store_"+i+" option:selected" ).text();
				$(this).html('<option>Appliances</option>');				
			  if(dta!= 0){  
			   var tdat = '<option value="'+dta+'">'+dtav+'</option>';  
			   optVal = optVal+tdat;
			  }
			...
			$('#purchase_laptop').click(function(){
			 var optVal = '';
			 for(var i=1; i<=6; i++){
			  var dta = $('#laptop_store_'+i).val();
			  var dtav = $( "#laptop_store_"+i+" option:selected" ).text(); 
				$(this).html('<option>Laptop</option>');
			  if(dta!= 0){  
			   var tdat = '<option value="'+dta+'">'+dtav+'</option>';  
			   optVal = optVal+tdat;
			  }
			...
			$('#purchase_kitchen_product').click(function(){
			 var optVal = '';
			 for(var i=1; i<=6; i++){
			  var dta = $('#kitchen_store_'+i).val();
			  var dtav = $( "#kitchen_store_"+i+" option:selected" ).text(); 
				$(this).html('<option>Kitchen Appliances</option>');
			  if(dta!= 0){  
			   var tdat = '<option value="'+dta+'">'+dtav+'</option>';  
			   optVal = optVal+tdat;
			  }
			...
			$('#purchase_tv').click(function(){
			 var optVal = '';
			 for(var i=1; i<=6; i++){
			  var dta = $('#tv_store_'+i).val();
			  var dtav = $( "#tv_store_"+i+" option:selected" ).text(); 
				$(this).html('<option>Television</option>');
			  if(dta!= 0){  
			   var tdat = '<option value="'+dta+'">'+dtav+'</option>';  
			   optVal = optVal+tdat;
			  }
