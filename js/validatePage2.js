...
//start kitchen section//
 ...
 //26march16//
  ...
  {
    if(get_id("product_brought_5").checked==true){
      chkVar = isFilledText("kitchen_model_name","0",'Please select model name',0);
    }
  }
...
///17june
//start not purchased not visited chroma personel care//
  if(chkVar==true)
  {
    if((get_id("product_brought_9").checked==true)
      ...
      && ($("#personel_care_store_3 option:selected").val()!="2" && $("#personel_care_store_3 option:selected").val()!="13")
      && ($("#personel_care_store_4 option:selected").val()!="2" && $("#personel_care_store_4 option:selected").val()!="13")
      && ($("#personel_care_store_5 option:selected").val()!="2" && $("#personel_care_store_5 option:selected").val()!="13")
      && ($("#personel_care_store_6 option:selected").val()!="2" && $("#personel_care_store_6 option:selected").val()!="13")
      ) {
     // alert('here');
