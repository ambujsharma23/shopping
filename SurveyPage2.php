    ...
    <head>
        ...
        <script type="text/javascript">
            function addPurchaseVisitedPanel(product, store, counter) {
                ...
                htmlData += '      <td style="width:10%;border:0px solid #cccccc;"><input type="radio" class="visited_radio" name="' + product + '_visited_radio_' + counter + '" id="' + product + '_likely_to_recommend_new2_' + store + '" value="2"></td>';
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                //24 Nov 17
                $("#tablet_primary_user_div").hide();
                $("#laptop_primary_user_div").hide();
                $("#mobile_primary_user_div").hide();
                $("#tv_primary_user_div").hide();
                $("#kitchen_primary_user_div").hide();
                $("#large_appliance_primary_user_div").hide();
                $("#personel_care_primary_user_div").hide();
                //24 Nov 17
                ...
                $("#product_brought_6").click(function () {
                    if ($('#product_brought_6').is(":checked")) {
                        ...
                        //24 Nov 17
                        $("#large_appliance_primary_user_div").show();
                    } else {
                        //$("#purchase_appliances").prop('selectedIndex', 0);
                        $("#appliance_div").hide();
                        $("#visit_large_appliance_div").hide();
                ...
                $("#product_brought_9").click(function () {
                    if ($('#product_brought_9').is(":checked")) {
                        ...
                        //24 Nov 17
                        $("#personel_care_primary_user_div").show();
                    } else {
                        //$("#purchase_personel_care").prop('selectedIndex', 0);
                        $("#personel_care_div").hide();
                        $("#visit_personel_care_div").hide();
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#primary_user_tablet").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_tablet_gender_other").show();
                        $("#primary_user_tablet_gender").attr('name', 'primary_user_tablet_gender');
                        $("#primary_user_tablet_gender1").removeAttr('name');
                        $('#primary_user_tablet_gender1').val("");
                    } else {
                        $("#primary_user_tablet_gender_other").hide();
                        $("#primary_user_tablet_gender").removeAttr('name');
                        if (gen == '1') {
                            $('#primary_user_tablet_gender1').val('<?php echo $g; ?>');
                        } else {
                            getGEnder(gen, '#primary_user_tablet_gender1');
                        }
                        $("#primary_user_tablet_gender1").attr('name', 'primary_user_tablet_gender');
                    }
                });



                $("#primary_user_laptop").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_laptop_gender_other").show();
                        $("#primary_user_laptop_gender").attr('name', 'primary_user_laptop_gender');
                        ...
                        if (gen == '1') {
                            ...
                            getGEnder(gen, '#primary_user_laptop_gender1');
                        }
                        $("#primary_user_laptop_gender1").attr('name', 'primary_user_laptop_gender');
                    }

                });

                $("#primary_user_mobile").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_mobile_gender_other").show();
                        $("#primary_user_mobile_gender").attr('name', 'primary_user_mobile_gender');
                        ...
                        if (gen == '1') {
                            ...
                            getGEnder(gen, '#primary_user_mobile_gender1');
                        }
                        $("#primary_user_mobile_gender1").attr('name', 'primary_user_mobile_gender');
                    }

//                    getGEnder(gen, '#primary_user_mobile_gender');
                });

                $("#primary_user_tv").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_tv_gender_other").show();
                        $("#primary_user_tv_gender").attr('name', 'primary_user_tv_gender');
                        ...
                        if (gen == '1') {
                            ...
                            getGEnder(gen, '#primary_user_tv_gender1');
                        }
                        $("#primary_user_tv_gender1").attr('name', 'primary_user_tv_gender');
                    }
//                    getGEnder(gen, '#primary_user_tv_gender');
                });

                $("#primary_user_kitchen").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_kitchen_gender_other").show();
                        $("#primary_user_kitchen_gender").attr('name', 'primary_user_kitchen_gender');
                        ...
                        if (gen == '1') {
                            ...
                            getGEnder(gen, '#primary_user_kitchen_gender1');
                        }
                        $("#primary_user_kitchen_gender1").attr('name', 'primary_user_kitchen_gender');
                    }


//                    getGEnder(gen, '#primary_user_kitchen_gender');
                });
                $("#primary_user_large_appliance").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_large_appliance_gender_other").show();
                        $("#primary_user_large_appliance_gender").attr('name', 'primary_user_large_appliance_gender');
                        ...
                        if (gen == '1') {
                            ...
                            getGEnder(gen, '#primary_user_large_appliance_gender1');
                        }
                        $("#primary_user_large_appliance_gender1").attr('name', 'primary_user_large_appliance_gender');
                    }


//                    getGEnder(gen, '#primary_user_large_appliance_gender');
                });
                $("#primary_user_personel_care").change(function () {
                    var gen = $(this).val();
                    if (gen == '96') {
                        $("#primary_user_personel_care_gender_other").show();
                        $("#primary_user_personel_care_gender").attr('name', 'primary_user_personel_care_gender');
                        ...
                        if (gen == '1') {
                            ...
                            getGEnder(gen, '#primary_user_personel_care_gender1');
                        }
                        $("#primary_user_personel_care_gender1").attr('name', 'primary_user_personel_care_gender');
                    }
//                    getGEnder(gen, '#primary_user_personel_care_gender');
                });
            });


            function getGEnder(val, id) {
                var gen_val;
                switch (val) {
                    case '1':
                        gen_val = '';
        ...
        <style type="text/css">
            ...
            #survey_terms .btn {
                background: url("https://img.etimg.com/photo/46444679.cms") repeat scroll -3px -3px rgba(0, 0, 0, 0) !important;
                cursor: pointer;
                float: left;
                height: 240px;
                position: relative;
                ...
                <div class="content2" id="purchase_reason_for_offline_tablet">
                    ...
                    <div class="content2_l1">
                        <div style="float: left;margin-right: 20px;">
                            <?php AddCheckBox1("purchase_reason_for_offline_tablet.xml", 'N', "purchase_reason_for_offline_tablet", "#7FB3E6", "0", "0", "2", "7", '100%', 'checknone1', false, array('this.id', 'this.value', '12', '12'), '1', '300px'); ?>
...
// AddCheckBox1("product_from_croma_appliance.xml",'N',"product_from_croma_appliance","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','12','12'),'1','300px');
                ...
                <!--   --->
                <!--24 nov 2017 start-->
                <div  class="content_14_n" style="width: 995px;" id="tablet_primary_user_div" style="display:none;">
                    <span class="content_l4_n_span" style="width:57%;float: left;color:#626262;">Who would be the primary user of this Tablet?</span>
                    <div style="margin-right: 20px;float: left">
                        <?php AddDropDown("primary_user.xml", "primary_user_tablet", "style_dd", "Select", "", "", "1"); ?>
                        <input type="hidden" value="" id="primary_user_tablet_gender1"/>
                    </div>
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_tablet_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_tablet_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>
                ...
                <div  class="content_14_n" style="width: 995px;" id="laptop_primary_user_div" style="display:none;">
                    ...
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_laptop_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_laptop_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>
                ...
                <div  class="content_14_n" style="width: 995px;" id="mobile_primary_user_div" style="display:none;">
                    ...
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_mobile_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_mobile_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>
                ...
                <div  class="content_14_n" style="width: 995px;" id="tv_primary_user_div" style="display:none;">
                    ...
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_tv_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_tv_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>                        
                    </div>
                    <div class="clear" style="clear: both"><br/></div>
                </div>
                ...
                <div  class="content_14_n" style="width: 995px;" id="kitchen_primary_user_div" style="display:none;">
                    ...
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_kitchen_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_kitchen_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>
                ...
                <div  class="content_14_n" style="width: 995px;" id="large_appliance_primary_user_div" style="display:none;">
                    ...
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_large_appliance_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_large_appliance_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>
                ...
                <div  class="content_14_n" style="width: 995px;" id="personel_care_primary_user_div" style="display:none;">
                    ...
                    <div style="margin-right: 20px;float: left;display: none" id="primary_user_personel_care_gender_other">
                        <?php AddDropDown("gender.xml", "primary_user_personel_care_gender", "style_dd", "Select Other Gender", "", "", "1"); ?>
    ...
    <script>
        get_id('tablet_store_1').onchange = function () {
            _checkDuplicateDropSix('tablet_store_1', 'tablet_store_2', 'tablet_store_3', 'tablet_store_4', 'tablet_store_5', 'tablet_store_6', 6);
        }
        get_id('tablet_store_2').onchange = function () {
            _checkDuplicateDropSix('tablet_store_2', 'tablet_store_1', 'tablet_store_3', 'tablet_store_4', 'tablet_store_5', 'tablet_store_6', 6);
        }
        get_id('tablet_store_3').onchange = function () {
            _checkDuplicateDropSix('tablet_store_3', 'tablet_store_2', 'tablet_store_1', 'tablet_store_4', 'tablet_store_5', 'tablet_store_6', 6);
        }
        get_id('tablet_store_4').onchange = function () {
            _checkDuplicateDropSix('tablet_store_4', 'tablet_store_3', 'tablet_store_2', 'tablet_store_1', 'tablet_store_5', 'tablet_store_6', 6);
        }
        get_id('tablet_store_5').onchange = function () {
            _checkDuplicateDropSix('tablet_store_5', 'tablet_store_4', 'tablet_store_3', 'tablet_store_2', 'tablet_store_1', 'tablet_store_6', 6);
        }
        get_id('tablet_store_6').onchange = function () {
            _checkDuplicateDropSix('tablet_store_6', 'tablet_store_5', 'tablet_store_4', 'tablet_store_3', 'tablet_store_2', 'tablet_store_1', 6);
        }

        get_id('mobile_store_1').onchange = function () {
            _checkDuplicateDropSix('mobile_store_1', 'mobile_store_2', 'mobile_store_3', 'mobile_store_4', 'mobile_store_5', 'mobile_store_6', 6);
        }
        get_id('mobile_store_2').onchange = function () {
            _checkDuplicateDropSix('mobile_store_2', 'mobile_store_1', 'mobile_store_3', 'mobile_store_4', 'mobile_store_5', 'mobile_store_6', 6);
        }
        get_id('mobile_store_3').onchange = function () {
            _checkDuplicateDropSix('mobile_store_3', 'mobile_store_2', 'mobile_store_1', 'mobile_store_4', 'mobile_store_5', 'mobile_store_6', 6);
        }
        get_id('mobile_store_4').onchange = function () {
            _checkDuplicateDropSix('mobile_store_4', 'mobile_store_3', 'mobile_store_2', 'mobile_store_1', 'mobile_store_5', 'mobile_store_6', 6);
        }
        get_id('mobile_store_5').onchange = function () {
            _checkDuplicateDropSix('mobile_store_5', 'mobile_store_4', 'mobile_store_3', 'mobile_store_2', 'mobile_store_1', 'mobile_store_6', 6);
        }
        get_id('mobile_store_6').onchange = function () {
            _checkDuplicateDropSix('mobile_store_6', 'mobile_store_5', 'mobile_store_4', 'mobile_store_3', 'mobile_store_2', 'mobile_store_1', 6);
        }

        get_id('laptop_store_1').onchange = function () {
            _checkDuplicateDropSix('laptop_store_1', 'laptop_store_2', 'laptop_store_3', 'laptop_store_4', 'laptop_store_5', 'laptop_store_6', 6);
        }
        get_id('laptop_store_2').onchange = function () {
            _checkDuplicateDropSix('laptop_store_2', 'laptop_store_1', 'laptop_store_3', 'laptop_store_4', 'laptop_store_5', 'laptop_store_6', 6);
        }
        get_id('laptop_store_3').onchange = function () {
            _checkDuplicateDropSix('laptop_store_3', 'laptop_store_2', 'laptop_store_1', 'laptop_store_4', 'laptop_store_5', 'laptop_store_6', 6);
        }
        get_id('laptop_store_4').onchange = function () {
            _checkDuplicateDropSix('laptop_store_4', 'laptop_store_3', 'laptop_store_2', 'laptop_store_1', 'laptop_store_5', 'laptop_store_6', 6);
        }
        get_id('laptop_store_5').onchange = function () {
            _checkDuplicateDropSix('laptop_store_5', 'laptop_store_4', 'laptop_store_3', 'laptop_store_2', 'laptop_store_1', 'laptop_store_6', 6);
        }
        get_id('laptop_store_6').onchange = function () {
            _checkDuplicateDropSix('laptop_store_6', 'laptop_store_5', 'laptop_store_4', 'laptop_store_3', 'laptop_store_2', 'laptop_store_1', 6);
        }

        get_id('tv_store_1').onchange = function () {
            _checkDuplicateDropSix('tv_store_1', 'tv_store_2', 'tv_store_3', 'tv_store_4', 'tv_store_5', 'tv_store_6', 6);
        }
        get_id('tv_store_2').onchange = function () {
            _checkDuplicateDropSix('tv_store_2', 'tv_store_1', 'tv_store_3', 'tv_store_4', 'tv_store_5', 'tv_store_6', 6);
        }
        get_id('tv_store_3').onchange = function () {
            _checkDuplicateDropSix('tv_store_3', 'tv_store_2', 'tv_store_1', 'tv_store_4', 'tv_store_5', 'tv_store_6', 6);
        }
        get_id('tv_store_4').onchange = function () {
            _checkDuplicateDropSix('tv_store_4', 'tv_store_3', 'tv_store_2', 'tv_store_1', 'tv_store_5', 'tv_store_6', 6);
        }
        get_id('tv_store_5').onchange = function () {
            _checkDuplicateDropSix('tv_store_5', 'tv_store_4', 'tv_store_3', 'tv_store_2', 'tv_store_1', 'tv_store_6', 6);
        }
        get_id('tv_store_6').onchange = function () {
            _checkDuplicateDropSix('tv_store_6', 'tv_store_5', 'tv_store_4', 'tv_store_3', 'tv_store_2', 'tv_store_1', 6);
        }

        get_id('kitchen_store_1').onchange = function () {
            _checkDuplicateDropSix('kitchen_store_1', 'kitchen_store_2', 'kitchen_store_3', 'kitchen_store_4', 'kitchen_store_5', 'kitchen_store_6', 6);
        }
        get_id('kitchen_store_2').onchange = function () {
            _checkDuplicateDropSix('kitchen_store_2', 'kitchen_store_1', 'kitchen_store_3', 'kitchen_store_4', 'kitchen_store_5', 'kitchen_store_6', 6);
        }
        get_id('kitchen_store_3').onchange = function () {
            _checkDuplicateDropSix('kitchen_store_3', 'kitchen_store_2', 'kitchen_store_1', 'kitchen_store_4', 'kitchen_store_5', 'kitchen_store_6', 6);
        }
        get_id('kitchen_store_4').onchange = function () {
            _checkDuplicateDropSix('kitchen_store_4', 'kitchen_store_3', 'kitchen_store_2', 'kitchen_store_1', 'kitchen_store_5', 'kitchen_store_6', 6);
        }
        get_id('kitchen_store_5').onchange = function () {
            _checkDuplicateDropSix('kitchen_store_5', 'kitchen_store_4', 'kitchen_store_3', 'kitchen_store_2', 'kitchen_store_1', 'kitchen_store_6', 6);
        }
        get_id('kitchen_store_6').onchange = function () {
            _checkDuplicateDropSix('kitchen_store_6', 'kitchen_store_5', 'kitchen_store_4', 'kitchen_store_3', 'kitchen_store_2', 'kitchen_store_1', 6);
        }

        get_id('large_appliance_store_1').onchange = function () {
            _checkDuplicateDropSix('large_appliance_store_1', 'large_appliance_store_2', 'large_appliance_store_3', 'large_appliance_store_4', 'large_appliance_store_5', 'large_appliance_store_6', 6);
        }
        get_id('large_appliance_store_2').onchange = function () {
            _checkDuplicateDropSix('large_appliance_store_2', 'large_appliance_store_1', 'large_appliance_store_3', 'large_appliance_store_4', 'large_appliance_store_5', 'large_appliance_store_6', 6);
        }
        get_id('large_appliance_store_3').onchange = function () {
            _checkDuplicateDropSix('large_appliance_store_3', 'large_appliance_store_2', 'large_appliance_store_1', 'large_appliance_store_4', 'large_appliance_store_5', 'large_appliance_store_6', 6);
        }
        get_id('large_appliance_store_4').onchange = function () {
            _checkDuplicateDropSix('large_appliance_store_4', 'large_appliance_store_3', 'large_appliance_store_2', 'large_appliance_store_1', 'large_appliance_store_5', 'large_appliance_store_6', 6);
        }
        get_id('large_appliance_store_5').onchange = function () {
            _checkDuplicateDropSix('large_appliance_store_5', 'large_appliance_store_4', 'large_appliance_store_3', 'large_appliance_store_2', 'large_appliance_store_1', 'large_appliance_store_6', 6);
        }
        get_id('large_appliance_store_6').onchange = function () {
            _checkDuplicateDropSix('large_appliance_store_6', 'large_appliance_store_5', 'large_appliance_store_4', 'large_appliance_store_3', 'large_appliance_store_2', 'large_appliance_store_1', 6);
        }

        get_id('personel_care_store_1').onchange = function () {
            _checkDuplicateDropSix('personel_care_store_1', 'personel_care_store_2', 'personel_care_store_3', 'personel_care_store_4', 'personel_care_store_5', 'personel_care_store_6', 6);
        }
        get_id('personel_care_store_2').onchange = function () {
            _checkDuplicateDropSix('personel_care_store_2', 'personel_care_store_1', 'personel_care_store_3', 'personel_care_store_4', 'personel_care_store_5', 'personel_care_store_6', 6);
        }
        get_id('personel_care_store_3').onchange = function () {
            _checkDuplicateDropSix('personel_care_store_3', 'personel_care_store_2', 'personel_care_store_1', 'personel_care_store_4', 'personel_care_store_5', 'personel_care_store_6', 6);
        }
        get_id('personel_care_store_4').onchange = function () {
            _checkDuplicateDropSix('personel_care_store_4', 'personel_care_store_3', 'personel_care_store_2', 'personel_care_store_1', 'personel_care_store_5', 'personel_care_store_6', 6);
        }
        get_id('personel_care_store_5').onchange = function () {
            _checkDuplicateDropSix('personel_care_store_5', 'personel_care_store_4', 'personel_care_store_3', 'personel_care_store_2', 'personel_care_store_1', 'personel_care_store_6', 6);
        }
        get_id('personel_care_store_6').onchange = function () {
            _checkDuplicateDropSix('personel_care_store_6', 'personel_care_store_5', 'personel_care_store_4', 'personel_care_store_3', 'personel_care_store_2', 'personel_care_store_1', 6);
        }
