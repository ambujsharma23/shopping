...
{
	$SQL = "INSERT INTO jc_shopping_home(IP,Browser,BrowVer,home_SessionId,Start_Dt_Tm,RFR,AT, subId) VALUES('".$ip."','".$bname."','".$bver ."','".$sessionid."',now(),'".mysql_real_escape_string($rfr)."','".mysql_real_escape_string($at)."', '".$_SESSION['subId']."')";
}
    ...
    <div class="header">
      ...
      <div class="content2" id="eduction_contribution">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">What is the highest education of the person who contributes the most towards the monthly household expense of your household (all members sharing the same kitchen)?</span>
            <div style="float:left;margin-right: 20px;">
            <?php AddDropDown2("highest_level_education.xml","highest_education_contribute","style_dd", "Highest Education", "", "", "1"); ?>
          </div>
      ...
      <div class="content2" id="occupation_contribution">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">What is the occupation of the person who contributes the most towards your monthly household expenses (all members sharing the same kitchen)?</span>
            <div style="float:left;margin-right: 20px;">
            <?php AddDropDown2("your_current_occupation2.xml","current_occupation_contribution","style_dd", "Current Occupation", "", "", "1"); ?>
          </div>
     ...
     <div class="content2">
       <div class="content2_l1">
          <span class="content2_l1_span">Which of the following products did you look around to buy during the last 2 weeks?</span>
     ...
     <div class="content2" id="first_three">
       <div class="content2_l1" style="width:995px;">
            <div style="float: left;padding-right: 10px;" id="tablet_div">
              <?php AddDropDown2("search_products.xml","search_tablet","style_dd", "Tablet", "", "", "1"); ?>
            </div>
            <div style="float: left;padding-right: 10px;" id="laptop_div">
            <?php AddDropDown2("search_products.xml","search_laptop","style_dd", "Laptop, Computer (Desktop)", "", "", "1"); ?>
            </div>
            <div id="kitchen_div">
              <?php AddDropDown2("search_products.xml","search_kitchen_product","style_dd", "Kitchen Appliances (Microwave,Mixer, Juicer ,Water Purifier, Air Fryer, etc.))", "", "", "1"); ?>
            </div>
        </div>
      </div>
      <div class="content2" id="second_three">
       <div class="content2_l1" style="width:995px;">
        <div style="float: left;padding-right: 10px;" id="mobile_div">
          <?php AddDropDown2("search_products.xml","search_mobile","style_dd", "Mobile Phone", "", "", "1"); ?>
        </div>
        <div style="float: left;padding-right: 10px;" id="tv_div">
        <?php AddDropDown2("search_products.xml","search_tv","style_dd", "Television (LCD/LED/3D)", "", "", "1"); ?>
            </div>
          <div id="appliance_div">
          <?php AddDropDown2("search_products.xml","search_appliances","style_dd", "Large Appliances (Refrigerator,AC,Washing Machine)", "", "", "1"); ?>
            </div>
        </div>
      </div>
      ...
      <div class="content2" id="third_three">
       <div class="content2_l1" style="width:995px;">
        <div style="float: left;padding-right: 10px;" id="personal_care_div">
          <?php AddDropDown2("search_products.xml","search_personal_care","style_dd", "Personal Care Appliances (Electric shavers, Trimmers, Hair Dryers, etc.)", "", "", "1"); ?>
        </div>
