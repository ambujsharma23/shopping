...
$(document).ready(function(){
    ...
    $('.products').click(function(){
     if($('#buy_product_1').is(":checked") || $('#buy_product_2').is(":checked") || $('#buy_product_3').is(":checked") || $('#buy_product_4').is(":checked") || $('#buy_product_5').is(":checked") || $('#buy_product_6').is(":checked")){
      $("#question_div").show();
    }else {
      $("#question_div").hide();
    }
...
<div class="wealthbutton"></div>
  <div class="parent_main">
    ...
    <div class="header">
      ...
      <div class="content2">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">Gender</span>
          <div style="float:left;margin-right: 20px;">
      ...
      <div class="content2">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">Age</span>
          <div style="float:left;margin-right: 20px;">
      ...
      <div class="content2">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">Your Highest Education</span>
            <div style="float:left;margin-right: 20px;">
      ...
      <div class="content2">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">Your Current Occupation</span>
            <div style="float:left;margin-right: 20px;">
      ...
      <div class="content2" id="occupation_contribution">
        <div class="content2_l1" style="width: 995px;">
          <span class="content2_l1_span" style="width:78%">What is the occupation of the person who contributes the most towards your monthly household expenses (all members sharing the same kitchen)?</span>
            <div style="float:left;margin-right: 20px;">
            <?php AddDropDown("your_current_occupation.xml","current_occupation_contribution","style_dd", "Current Occupation", "", "", "1"); ?>
          </div>
     ...
     <div class="content2">
       <div class="content2_l1">
          <span class="content2_l1_span">Did you look around to buy any of the following products during the last week, i.e., 8th August - 16th August 2015?</span>
            <div style="clear:both;margin-left:-12px;">
              <?php
              AddCheckBox1("products.xml",'N',"products","#7FB3E6","0","0","2","7",'100%','checknone1',false,array('this.id','this.value','7','7'),'1','400px');
              ?>
            </div>
     ...
     <div class="content2" id="first_three">
       <div class="content2_l1" style="width:995px;">
            ...
            <div id="kitchen_div">
              <?php AddDropDown("search_products.xml","search_kitchen_product","style_dd", "Kitchen Appliances (Microwave,Mixer,Juicer,etc)", "", "", "1"); ?>
            </div>
        </div>
      </div>
    ...
    <div class="content2" id="no_insurance_coverage1" style="width:995px">
      <span class="content2_l1_span" style="width:90%">Recently did you see any ads from any retailers for the product you have mentioned earlier?</span>
        <div class="content2_l1">
          <div style="float:left;margin-right: 20px;">
          <?php
