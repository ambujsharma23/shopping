...
<?php if($_REQUEST['code']!='failure'){ ?>
	<?php //if($_REQUEST['rfr']=='amu'  && $_REQUEST['SessionId']!= '' && $_REQUEST['show']=='1'){ ?>  
  <?php if($_REQUEST['rfr']=='amu'  && $_REQUEST['SessionId']!= '' ){ ?>  
		<script type="text/javascript"> 		
    document.write(unescape("%3Cscript src='http://www.amulyam.in/incent/onlineShopSurvey.jsp' type='text/javascript'%3E%3C/script%3E"));
		</script>
	<?php }  } ?>
</div>
</div>
