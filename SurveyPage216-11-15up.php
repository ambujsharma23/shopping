      ...
      <div class="content2_l1" style="width:995px;">
        ...
        <table width="100%">
          ...
          <tr style="text-align: center; width: 65%;  margin: 0px auto;">
            ...
            <tr style="text-align: center; width: 65%;  margin: 0px auto;">
            <td style="width:12%;border:0px solid #cccccc;"><label>1</label></td>
            <td style="width:11%;border:0px solid #cccccc;"></td>
            <td style="width:11%;border:0px solid #cccccc;"></td>
            <td style="width:11%;border:0px solid #cccccc;"></td>
            <td style=" width:11%;border:0px solid #cccccc;"><label>5</label></td>
            <td style=" width:11%;border:0px solid #cccccc;"></td>
            <td style=" width:11%;border:0px solid #cccccc;"></td>
            <td style=" width:11%;border:0px solid #cccccc;"></td>
            <td style=" width:11%;border:0px solid #cccccc;"></td>
            <td style=" width:11.5%;border:0px solid #cccccc;"><label>10</label></td>
          </tr>
        </table>
        ...
        <table width="100%">
          ...
          <tr style="text-align: center; width: 65%;  margin: 0px auto;">
           ...
           <tr style="text-align: center; width: 65%;  margin: 0px auto;">
            ...
            <td style=" width:10%;border:0px solid #cccccc;"></td>
            <td style=" width:10%;border:0px solid #cccccc;"></td>
            <td style=" width:10.5%;border:0px solid #cccccc;"><label>10</label></td>
          </tr>
                 </table>
      </div><div style="clear:both;"></div>
